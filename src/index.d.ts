// Types source: https://github.com/reduxjs/reselect/blob/master/src/index.d.ts
export as namespace Roselect;
...
export function defaultMemoize<F extends Callback>(
        func: F,
        equalityCheck?: <T>(a: T, b: T, index: number) => boolean
): F;

export function createSelectorCreator(
        memoize: <F extends Callback>(func: F) => F
): typeof createSelector;

export function createSelectorCreator<O1>(
        memoize: <F extends Callback>(func: F, option1: O1) => F,
        option1: O1
): typeof createSelector;

export function createSelectorCreator<O1, O2>(
        memoize: <F extends Callback>(func: F, option1: O1, option2: O2) => F,
        option1: O1,
        option2: O2
): typeof createSelector;

export function createSelectorCreator<O1, O2, O3>(
        memoize: <F extends Callback>(
                func: F,
                option1: O1,
                option2: O2,
                option3: O3,
